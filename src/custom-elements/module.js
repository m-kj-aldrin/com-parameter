...
<com-parameter order="0">
  <com-input type="range" min="0" max="1000" step="0.001">
    <label>frq</label>
  </com-input>
</com-parameter>
<com-parameter order="1">
  <com-input type="range" min="0" max="1" step="0.001">
    <label>amp</label>
  </com-input>
</com-parameter>
<com-parameter order="2">
  <com-input type="range" min="0" max="16" step="1">
...
export class ModuleElement extends HTMLElement {
  ...
  #attachListeners() {
    this.shadowRoot.addEventListener("click", this.#actionHandler.bind(this));
  }
